...
if ($templateName.$this->viewName == 'editSuccess')
{
  ...
  $response->addJavascript('core.js?version=20190927', '', array ());
  $response->addJavascript('/qtip2/dist/jquery.qtip.min.js', '', array ());
  $response->addJavascript('catalogue.js?version=20190527', '', array ());
  $response->addJavascript('superclick.js', '', array ());
  $response->addJavascript('/js/mousetrap/mousetrap.min.js', '', array ());
}
